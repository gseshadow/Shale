...
public final class MaterialRequestServiceAdapter implements MaterialRequestServicePort {
    ...
    public MaterialRequestDetailDto createMaterialRequest(CreateMaterialRequestCommand command){return dao.create(Objects.requireNonNull(command));}
    public MaterialRequestDetailDto updateMaterialRequest(UpdateMaterialRequestCommand command){return dao.update(Objects.requireNonNull(command));}
    public MaterialRequestDetailDto changeMaterialRequestStatus(ChangeMaterialRequestStatusCommand command){return dao.changeStatus(Objects.requireNonNull(command));}
    public void deleteMaterialRequest(DeleteMaterialRequestCommand command){dao.delete(Objects.requireNonNull(command));}
    ...
    public FollowUpResult recordFollowUp(RecordMaterialRequestFollowUpCommand command){return dao.recordFollowUp(Objects.requireNonNull(command));}
}
