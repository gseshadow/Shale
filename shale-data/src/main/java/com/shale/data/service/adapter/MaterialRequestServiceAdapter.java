...
public final class MaterialRequestServiceAdapter implements MaterialRequestServicePort {
    ...
    public MaterialRequestDetailDto createMaterialRequest(CreateMaterialRequestCommand command){validateRequestedFrom(command.requestedFromContactId(),command.requestedFromOrganizationId());return dao.create(command);}
    public MaterialRequestDetailDto updateMaterialRequest(UpdateMaterialRequestCommand command){validateRequestedFrom(command.requestedFromContactId(),command.requestedFromOrganizationId());return dao.update(command);}
