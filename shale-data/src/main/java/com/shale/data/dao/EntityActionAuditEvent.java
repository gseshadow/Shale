...
public record EntityActionAuditEvent(
	...
	public enum EntityType { CONTACT, CONTACT_PHONE_NUMBER, CONTACT_EMAIL_ADDRESS, CONTACT_ADDRESS, ORGANIZATION, ORGANIZATION_PHONE, ORGANIZATION_EMAIL, ORGANIZATION_ADDRESS, ORGANIZATION_WEBSITE, CASE, CASE_OVERVIEW_CONFIGURATION, CASE_STATUS, LINK_TYPE, CASE_LINK, CASE_LINK_SHARE, CASE_DATE, CASE_DATE_TYPE, CASE_TEAM_ROLE, CASE_TEAM_MEMBER, CASE_TEAM_MEMBER_ROLE, FIRM_WIDE_ROLE, USER_FIRM_WIDE_ROLE, CALENDAR_EVENT, CASE_DATE_ROLE_MAPPING, FORM_CONFIGURATION, MATERIAL_TYPE, MATERIAL_REQUEST, MATERIAL_REQUEST_FOLLOW_UP, MATERIAL_ITEM, USER, CONTACT_TYPE, SPECIALTY, CREDENTIAL_DEFINITION, CONTACT_CONTACT_TYPE, CONTACT_SPECIALTY, CONTACT_CREDENTIAL, ORGANIZATION_TYPE, ORGANIZATION_ORGANIZATION_TYPE }
