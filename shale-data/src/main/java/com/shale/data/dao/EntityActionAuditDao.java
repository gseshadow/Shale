...
public final class EntityActionAuditDao {
	...
	private static boolean isAllowedMetadataKey(String key) {
		...
		return java.util.Set.of("CASE_ID","CASE_LINK_ID","CASE_LINK_SHARE_ID","CASE_DATE_ID","CALENDAR_EVENT_ID","CALENDAR_EVENT_TYPE_ID","EXTERNAL_LINK_ID","LINK_TYPE_ID","CONTACT_ID","PREVIOUS_PRIMARY_CASE_LINK_ID","NEW_PRIMARY_CASE_LINK_ID","REORDERED_LINK_COUNT","ACTIVE","TARGET_USER_ID","FORM_CONFIGURATION_ID","FORM_KEY","SECTION_COUNT","CONFIGURED_FIELD_COUNT","INITIAL_CREATION","SEMANTIC_ROLE","CASE_DATE_TYPE_ID","DEFINITION_ID","ORDERING_COUNT").contains(key);
	}
