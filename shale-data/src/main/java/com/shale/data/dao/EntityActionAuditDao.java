...
public final class EntityActionAuditDao {
	...
	private static boolean isAllowedMetadataKey(String key) {
		...
		return java.util.Set.of("CASE_ID","CASE_LINK_ID","CASE_LINK_SHARE_ID","EXTERNAL_LINK_ID","LINK_TYPE_ID","CONTACT_ID","PREVIOUS_PRIMARY_CASE_LINK_ID","NEW_PRIMARY_CASE_LINK_ID","REORDERED_LINK_COUNT","ACTIVE").contains(key);
	}
