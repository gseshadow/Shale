...
final class OrganizationsPhase1CAuditMigrationContractTest {
	@Test void migrationIsGuardedRerunnableAndOnlyExpandsEntityTypeAllowlist() throws Exception {
		String s=Files.readString(Path.of("docs/sql/2026-09-09_organizations_phase1c_audit_allowlist.sql"));
	...
	@Test void verificationIsReadOnlyAndChecksBothTokens() throws Exception {
		String s=Files.readString(Path.of("docs/sql/verification/2026-09-09_organizations_phase1c_audit_allowlist_verification.sql"));
