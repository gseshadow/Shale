...
final class OrganizationSearchCriteriaTest {
 ...
 @Test void lifecycleIsExplicitAndActiveByDefault(){assertEquals(OrganizationDao.OrganizationLifecycleMode.ACTIVE_ONLY,new OrganizationDao.OrganizationSearchCriteria(7,"",List.of(),null,null,0,10).lifecycleMode());assertEquals(OrganizationDao.OrganizationLifecycleMode.REMOVED_ONLY,new OrganizationDao.OrganizationSearchCriteria(7,"",List.of(),null,null,OrganizationDao.OrganizationLifecycleMode.REMOVED_ONLY,0,10).lifecycleMode());}
}
