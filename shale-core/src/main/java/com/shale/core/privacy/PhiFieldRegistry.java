package com.shale.core.privacy;
...
public final class PhiFieldRegistry {
    private static final Set<FieldRef> PHI_FIELDS = Set.of(
            ...
            field("CaseDates", "StartsAt"),
            field("CaseDates", "EndsAt"),
            field("CaseDates", "Notes"),
            ...
            field("MaterialRequests", "RequestedRangeStartDate"),
            field("MaterialRequests", "RequestedRangeEndDate"),
