...
public record CompatibilityCaseDateState(
    ...
    public CompatibilityCaseDateState {
        ...
        boolean availableAbsent = expectedAbsent != null;
        if (present != (occurrenceRowVer != null) || present != (startsAt != null) || present != (caseDateTypeId != null)
                || (present && availableAbsent))
            throw new IllegalArgumentException("State must be present, explicitly absent, or unavailable.");
