...
INSERT @Seeds VALUES
(N'intake',N'Intake','OTHER',N'#475569',1,5),(N'date_of_injury',N'Date of Injury','OTHER',N'#7C3AED',0,40),(N'date_of_medical_negligence',N'Date of Medical Negligence','OTHER',N'#9333EA',0,50),(N'medical_negligence_discovered',N'Medical Negligence Discovered','OTHER',N'#A855F7',0,60),(N'statute_of_limitations',N'Statute of Limitations','DEADLINE',N'#DC2626',0,10),(N'tort_notice_deadline',N'Tort Notice Deadline','DEADLINE',N'#EA580C',0,20),(N'discovery_deadline',N'Discovery Deadline','DEADLINE',N'#D97706',0,30),(N'fee_agreement_signed',N'Fee Agreement Signed','MILESTONE',N'#16A34A',0,110),(N'non_engagement_letter_sent',N'Non-Engagement Letter Sent','MILESTONE',N'#64748B',0,120);
