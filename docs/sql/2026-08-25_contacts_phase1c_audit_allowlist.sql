/*
 * Contacts Phase 1C forward-only EntityActionAuditLog EntityType allowlist successor.
...
BEGIN TRY
    ...
    /* Exact chronological union: all deployed historical tokens plus the six Phase 1C tokens. */
