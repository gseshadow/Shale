...
SELECT N'02_OCCURRENCE_USAGE' SectionName,t.Id CaseDateTypeId,t.SystemKey,cd.ShaleClientId,COUNT_BIG(*) OccurrenceCount,
...
SELECT N'03_FORM_REFERENCES' SectionName,t.Id CaseDateTypeId,t.SystemKey,f.ShaleClientId,COUNT_BIG(*) ConfiguredFieldCount,
