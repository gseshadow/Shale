/*
  ...
  - Seed missing global built-in rows after ShaleClientId nullability is enabled.
...
BEGIN
    THROW 51010, 'dbo.Statuses.ShaleClientId is NOT NULL. Run the nullable migration first.', 1;
END;
