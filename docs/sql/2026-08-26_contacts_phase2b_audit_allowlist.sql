/*
 * Contacts Phase 2B forward-only EntityActionAuditLog EntityType allowlist successor.
...
BEGIN TRY
    ...
    /* Exact chronological union: all deployed historical tokens plus the Phase 1C tokens and the Phase 2B CONTACT token. */
