...
| `RequestMethods` | Mature/comparatively mature overlay | Type/length differs from preferred `SystemKey`; verify compatibility | Moderate; request workflow/reporting | Phase 2 | Preserve legacy `MaterialRequests` text method compatibility during migration. |
