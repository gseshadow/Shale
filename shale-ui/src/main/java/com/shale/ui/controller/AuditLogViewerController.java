...
public final class AuditLogViewerController {
    ...
    static String friendlyEntity(String entityType) { return switch (entityType == null ? "" : entityType) { case "CASE" -> "Case"; case "LINK_TYPE" -> "Link Type"; case "CASE_LINK" -> "Case Link"; case "CASE_LINK_SHARE" -> "Shared Contact"; case "MATERIAL_TYPE" -> "Material Type"; case "MATERIAL_REQUEST" -> "Material Request"; case "MATERIAL_REQUEST_FOLLOW_UP" -> "Material Request Follow-up"; case "MATERIAL_ITEM" -> "Material Item"; default -> "Entity (" + (entityType == null ? "unknown" : entityType) + ")"; }; }
