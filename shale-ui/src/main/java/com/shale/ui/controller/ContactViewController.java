...
public final class ContactViewController {
    ...
    private void showProfileEditor(){
        ...
        Label preview=new Label();preview.setWrapText(true);preview.getStyleClass().add("contact-editor-name-preview");Runnable previewer=()->preview.setText("Structured-name preview: "+structuredPreview(prefix.getText(),first.getText(),middle.getText(),last.getText(),preferred.getText(),suffix.getText()));
