...
public final class SettingsController {
	...
	private void setCaseDateTypeMessage(String msg){if(caseDateTypeSettingsStatusLabel!=null)caseDateTypeSettingsStatusLabel.setText(msg==null?"":msg);} private void showCaseDateTypeError(RuntimeException ex){LOG.error("Case Date Type administration mutation failed",ex);AppDialogs.showError(caseDateTypeCardsContainer==null||caseDateTypeCardsContainer.getScene()==null?null:caseDateTypeCardsContainer.getScene().getWindow(),"Case Date Types","The Case Date Type could not be saved. Contact an administrator if the problem continues.");}
