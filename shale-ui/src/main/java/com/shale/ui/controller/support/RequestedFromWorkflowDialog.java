...
public final class RequestedFromWorkflowDialog {
    ...
    public static Selection show(Window owner, Supplier<DirectoryData> directoryLoader, Executor executor) {
        ...
        ScrollPane caseResultsScroll = new ScrollPane(caseResults); caseResultsScroll.setFitToWidth(true); caseResultsScroll.setHbarPolicy(ScrollPane.ScrollBarPolicy.NEVER); caseResultsScroll.setVbarPolicy(ScrollPane.ScrollBarPolicy.AS_NEEDED); caseResultsScroll.setMinHeight(56); caseResultsScroll.setPrefHeight(104); caseResultsScroll.setMaxHeight(140); caseResultsScroll.getStyleClass().add("case-link-case-contacts-scroll");
